...
class Face(FullBody_LM):
    ...
    def Find_Points(self, image, imageRGB):
        ...
        def Chin():
            if len(Points) != 0:
                NoseXL, NoseYL = Points[152][1], Points[100][2]
        ...
        def Nose_Bottom():
            if len(Points) != 0:
                NoseXL, NoseYL = Points[2][1], Points[2][2]
